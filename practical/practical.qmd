...
With the Women's EURO 2025 final coming up this weekend, we'll be using
data on `r team`'s performances over the past year.

You will:

* Build models to predict `r team`'s chance of winning their next match.
