...
* [GitHub Desktop](https://github.com/apps/desktop) (optional), a user-friendly way to interact with Git and GitHub.
...
```{text style="padding-left:4rem; font-size: 1.2rem;"}
1-data/
├── raw/
│   └── fixtures.csv
└── clean/
